...
action_0,
 ...
 action_67,
 action_68,
 action_69 :: () => Int -> ({-HappyReduction (Except CompilerError) = -}
	   Int 
	-> (Token)
	-> HappyState (Token) (HappyStk HappyAbsSyn -> [(Token)] -> (Except CompilerError) HappyAbsSyn)
	-> [HappyState (Token) (HappyStk HappyAbsSyn -> [(Token)] -> (Except CompilerError) HappyAbsSyn)] 
	-> HappyStk HappyAbsSyn 
	-> [(Token)] -> (Except CompilerError) HappyAbsSyn)
...
happyReduce_1,
 ...
 happyReduce_37,
 happyReduce_38,
 happyReduce_39 :: () => ({-HappyReduction (Except CompilerError) = -}
	   Int 
	-> (Token)
	-> HappyState (Token) (HappyStk HappyAbsSyn -> [(Token)] -> (Except CompilerError) HappyAbsSyn)
	-> [HappyState (Token) (HappyStk HappyAbsSyn -> [(Token)] -> (Except CompilerError) HappyAbsSyn)] 
...
happyThen :: () => Except CompilerError a -> (a -> Except CompilerError b) -> Except CompilerError b
happyThen = (>>=)
happyReturn :: () => a -> Except CompilerError a
happyReturn = (return)
happyThen1 m k tks = (>>=) m (\a -> k a tks)
happyReturn1 :: () => a -> b -> Except CompilerError a
happyReturn1 = \a tks -> (return) a
happyError' :: () => ([(Token)], [String]) -> Except CompilerError a
